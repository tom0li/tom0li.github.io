...
5、**自定义输入法**。  
6、**自定义浏览器**，浏览器配置(user.js)、浏览器插件、证书、自定义浏览器设置 (浏览器每次浏览器操作后清空cookie、Indexed DB、本地存储 等存储、历史记录、缓存、网站设置、搜索历史等记录；自定义搜索建议；自定义数据反馈；自定义安全等)。  
7、**自定义APP应用权限**  
...
24、注意**盲水印**。  
25、智能家居，运营商把家庭网络和设备分到公网或网络隔离不当带来的威胁。智能家居的内网信息收集行为等。  
