...
---
	...
	nslookup -type=SRV tom.com  /查看域控
	dsquery
	dsquery user /查询域用户
	dsquery computer /查询域主机
	...
	arp -a
	setspn.exe -q */*   查看当前域内的所有SPN
	setspn.exe -T test -q */*  查看test域内的所有SPN
...
过360添加 https://github.com/newsoft/adduser
