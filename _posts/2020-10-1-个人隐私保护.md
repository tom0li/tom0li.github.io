...
1、混淆数据，通过泄漏适量的假个人基本信息数据，**多个身份**活动。  
...
17、使用云服务时，使用上文提到的**加密工具**，不存储核心信息。  
18、尽量不使用个人的人脸、指纹、虹膜等人体信息。  
19、**关闭不需要的功能**。比如个性化、广告营销、搜索帐号、添加方式、展示动态等。  
20、应对丢失手机**SIM**卡：核心SIM卡放置到安全位置，不携带，并设置SIM卡密码，通过互联网加密转发到邮箱服务器，获取短信验证码，拨打电话使用互联网或其它。  
21、每次浏览器操作后清空cookie、Indexed DB、本地存储 等存储、历史记录、缓存、网站设置、搜索历史等记录。  
22、不在**他人设备**登录个人帐号，不在个人设备**登录他人帐号**，因为涉及隐私和安全问题。  
23、一个服务一个帐号，每个帐号不给其它服务**授权**。  
24、金融支付每日额度和单笔额度限额，快捷支付谨慎授权，转账设置延迟时间24h，隐藏个人界面存款余额，减少泄漏资产信息。  
25、分散存储资产，配置资金防火墙，被限制自由时，个人无法短时间给其转账 被勒索。 多种类型资产(银行存款、纸币、基金、股票、地产、虚拟货币、字画古玩、硬通货物品、投资产品、股权等)，多种区域资产(多地)，不同名下资产，减少泄漏资产信息。  
26、**自建**密码本，自建语言。  
27、明确对方目的，及时调整后续策略，不重要的就满足对方。  
28、上面提到的个人隐私保护具体问题及操作。  
29、定期查询征信(名下贷款是否正常)、名下公司注册信息、名下银行卡信息、名下手机号。  
30、定期查询帐号登录位置、设备信息。  
31、细读隐私协议，包括基本服务和新功能的 使用协议、授权协议等。  
32、定期关注泄漏信息，信息产业链，根据流动链判断，直接包？To C？机器学习数据、要销售产品服务的公司、诈骗组织、大组织、竞争公司等等。  
33、**控制**APP应用权限和不同协议返回的数据。  
