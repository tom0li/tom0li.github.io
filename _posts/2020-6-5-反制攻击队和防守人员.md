---
title: 反制攻击队和防守人员
description: 反制攻击队思路(待完善),提供一些思路,攻击队和防守人员都适用。
tagline: 反制攻击队/反制攻击方/反制红队/蓝队反制/防守方反制
author: tom0li
...
---
文件信息共享（网盘、在线共享网站、贴吧、知乎、微博等）、代码托管（git、码云等）、社交应用（qq、微信、钉钉、电报）、社工裤（论坛、tg）、招聘（脉脉、领英、boos）、有住房信息的平台(酒店、自如、a)、安全信息网站。
...
Mysql读文件&反序列化  
Mysql client 开启 --enable-local-infile 允许读取客户端文件
http://scz.617.cn:8/network/202001101612.txt
http://scz.617.cn:8/network/202005011956.txt
